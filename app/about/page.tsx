...
import {
  ...
  Wrench as Tool, Heart, Target, Users,
} from 'lucide-react';
    ...
    <>
      ...
      <main className="pt-16 bg-background">
        ...
        <section className="section-padding bg-[#111111] text-white relative overflow-hidden">
          ...
          <div className="container-max relative">
            <ScrollReveal className="max-w-3xl">
              ...
              <h1 className="text-display-lg font-heading font-extrabold leading-[1.05] mb-6">
                Two brothers.<br />
                A printer.<br />
                <span className="text-[#F9733E]">A desire to make things personal.</span>
              </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <ScrollReveal>
                <div className="relative">
                  <div className="aspect-[4/5] rounded-2xl bg-gradient-to-br from-muted/40 to-muted/10 dark:from-white/5 dark:to-transparent border border-border overflow-hidden relative">
                    {/* Stylized founder illustration placeholder */}
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        <div className="flex items-center justify-center gap-4 mb-6">
                          <div className="w-24 h-24 rounded-full bg-[#F9733E]/20 border-2 border-[#F9733E]/40 flex items-center justify-center">
                            <Users className="w-10 h-10 text-[#F9733E]" />
                          </div>
                          <div className="w-24 h-24 rounded-full bg-[#F9733E]/20 border-2 border-[#F9733E]/40 flex items-center justify-center">
                            <Users className="w-10 h-10 text-[#F9733E]" />
                          </div>
                        </div>
                        <p className="font-display text-xl font-bold text-foreground">MARWAN & MUHANNAD</p>
                        <p className="text-xs text-muted-foreground mt-1">Founders · Workshop portrait coming soon</p>
                      </div>
                    </div>
                    <div
                  ...
                  <div className="absolute -bottom-4 -right-4 bg-[#F9733E] text-white px-4 py-3 rounded-lg shadow-forge-orange">
                    <p className="font-display text-2xl font-bold leading-none">2</p>
                    <p className="text-xs mt-0.5">brothers</p>
                  </div>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal delay={150}>
                <div>
                  ...
                  <h2 className="text-display-sm font-heading font-extrabold text-foreground mb-4">
        ...
        <section className="section-padding bg-[#F8F8F8] dark:bg-[#1A1A1A]">
          <div className="container-max">
            <ScrollReveal className="text-center max-w-2xl mx-auto mb-12">
              ...
              <h2 className="text-display-sm font-heading font-extrabold text-foreground">Three things we won&apos;t compromise on.</h2>
            </ScrollReveal>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {VALUES.map((value, i) => (
                <ScrollReveal key={value.title} delay={i * 120}>
                  <div className="h-full p-8 rounded-xl border border-border bg-card hover:shadow-forge transition-all duration-300">
                    <div className="p-3 rounded-md bg-[#F9733E]/10 w-fit mb-5">
                      <value.icon className="w-6 h-6 text-[#F9733E]" />
                    </div>
                    <h3 className="text-heading-md font-heading font-semibold text-foreground mb-3">{value.title}</h3>
        ...
        <section className="section-padding bg-background">
          <div className="container-max">
            <ScrollReveal className="max-w-2xl mb-12">
              ...
              <h2 className="text-display-sm font-heading font-extrabold text-foreground">From kitchen table to your hands.</h2>
            </ScrollReveal>
        ...
        <section className="section-padding bg-[#111111] text-white relative overflow-hidden">
          ...
          <div className="container-max relative">
            <ScrollReveal className="text-center max-w-2xl mx-auto mb-14">
              ...
              <h2 className="text-display-sm font-heading font-extrabold">How a Twin Forge trainer is made.</h2>
            </ScrollReveal>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {[
                ...
                { icon: Shield, label: 'QA', desc: 'Flip-test' },
                { icon: Hammer, label: 'Ship', desc: 'To your door' },
              ].map((step, i) => (
                <ScrollReveal key={step.label} delay={i * 80}>
                  <div className="relative">
                    <div className="absolute -top-3 -left-3 w-7 h-7 rounded-full bg-[#F9733E]/10 border border-[#F9733E]/30 flex items-center justify-center text-[#F9733E] text-[10px] font-bold">
                      {i + 1}
                    </div>
                    <div className="p-5 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 hover:border-[#F9733E]/40 transition-all duration-300 h-full">
                      <step.icon className="w-5 h-5 text-[#F9733E] mb-3" />
        ...
        <section className="section-padding bg-background">
          <div className="container-max">
            <ScrollReveal>
              <div className="relative rounded-2xl bg-gradient-to-br from-[#F9733E] to-[#e85e28] text-white p-12 md:p-16 overflow-hidden">
