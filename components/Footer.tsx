...
export function Footer() {
  return (
    <footer className="bg-[#0a0a0a] text-white relative overflow-hidden">
      <div className="absolute -top-32 left-1/4 w-96 h-96 rounded-full bg-[#F9733E]/5 blur-3xl pointer-events-none" />
      <div className="absolute -bottom-32 right-1/4 w-80 h-80 rounded-full bg-[#F9733E]/5 blur-3xl pointer-events-none" />

      <div className="section-padding border-b border-white/10 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            <div className="lg:col-span-2">
              ...
              <div className="flex items-center gap-3">
                <a href="https://instagram.com/twinforge.om" target="_blank" rel="noopener noreferrer" aria-label="Instagram @twinforge.om" className="p-2.5 rounded-lg text-white/40 hover:text-[#F9733E] hover:bg-white/5 transition-all duration-200">
                  <Instagram className="w-4 h-4" />
                </a>
                <a href="mailto:twinforge.om@gmail.com" aria-label="Email Twin Forge" className="p-2.5 rounded-lg text-white/40 hover:text-[#F9733E] hover:bg-white/5 transition-all duration-200">
                  <Mail className="w-4 h-4" />
                </a>
                <a href="tel:+96891232926" aria-label="Call Twin Forge" className="p-2.5 rounded-lg text-white/40 hover:text-[#F9733E] hover:bg-white/5 transition-all duration-200">
      ...
      <div className="px-6 py-4 bg-black/30 relative">
